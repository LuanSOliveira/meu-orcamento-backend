...
export class CreateTables1709902602008 implements MigrationInterface {
    name = 'CreateTables1709902602008'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "lines_budget_budgets" ("linesId" uuid NOT NULL, "budgetsId" uuid NOT NULL, CONSTRAINT "PK_187bf7c6ef51110ccb6c0e5336f" PRIMARY KEY ("linesId", "budgetsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_97aec10e141c2b8f2e2bc5b940" ON "lines_budget_budgets" ("linesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_466dfae0822bb332cca815dab1" ON "lines_budget_budgets" ("budgetsId") `);
        ...
        await queryRunner.query(`CREATE TABLE "other-materials_budget_budgets" ("otherMaterialsId" uuid NOT NULL, "budgetsId" uuid NOT NULL, CONSTRAINT "PK_4d4bbf6238d7642a30ee3893c0f" PRIMARY KEY ("otherMaterialsId", "budgetsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3f5b62a8a17c00a684d24bca9c" ON "other-materials_budget_budgets" ("otherMaterialsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_5f867508881d66d79a9392ab29" ON "other-materials_budget_budgets" ("budgetsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "lines_budget_budgets" ADD CONSTRAINT "FK_97aec10e141c2b8f2e2bc5b9406" FOREIGN KEY ("linesId") REFERENCES "lines"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "lines_budget_budgets" ADD CONSTRAINT "FK_466dfae0822bb332cca815dab19" FOREIGN KEY ("budgetsId") REFERENCES "budgets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "other-materials_budget_budgets" ADD CONSTRAINT "FK_3f5b62a8a17c00a684d24bca9c5" FOREIGN KEY ("otherMaterialsId") REFERENCES "other-materials"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "other-materials_budget_budgets" ADD CONSTRAINT "FK_5f867508881d66d79a9392ab29d" FOREIGN KEY ("budgetsId") REFERENCES "budgets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "other-materials_budget_budgets" DROP CONSTRAINT "FK_5f867508881d66d79a9392ab29d"`);
        await queryRunner.query(`ALTER TABLE "other-materials_budget_budgets" DROP CONSTRAINT "FK_3f5b62a8a17c00a684d24bca9c5"`);
        ...
        await queryRunner.query(`ALTER TABLE "lines_budget_budgets" DROP CONSTRAINT "FK_466dfae0822bb332cca815dab19"`);
        await queryRunner.query(`ALTER TABLE "lines_budget_budgets" DROP CONSTRAINT "FK_97aec10e141c2b8f2e2bc5b9406"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5f867508881d66d79a9392ab29"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3f5b62a8a17c00a684d24bca9c"`);
        await queryRunner.query(`DROP TABLE "other-materials_budget_budgets"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_466dfae0822bb332cca815dab1"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_97aec10e141c2b8f2e2bc5b940"`);
        await queryRunner.query(`DROP TABLE "lines_budget_budgets"`);
