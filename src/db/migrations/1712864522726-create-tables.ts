...
export class CreateTables1712864522726 implements MigrationInterface {
    name = 'CreateTables1712864522726'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "lines" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deleted_at" TIMESTAMP, "created_at" TIMESTAMP DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "image_link" character varying NOT NULL, "value" character varying NOT NULL, "weight_line" character varying NOT NULL, "points_per_weight_qt" character varying NOT NULL, "weight_per_points" character varying NOT NULL, "hours_points-qt" character varying NOT NULL, "minutes_per_points" character varying NOT NULL, "other_informations" character varying(1000) NOT NULL, "lineMarkId" uuid, "lineTypeId" uuid, CONSTRAINT "PK_155ad34738bc0e1aab0ca198dea" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "budgets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deleted_at" TIMESTAMP, "created_at" TIMESTAMP DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying NOT NULL, "link_recipe" character varying, "extra_time" character varying NOT NULL, "freight" character varying, CONSTRAINT "PK_9c8a51748f82387644b773da482" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "other-materials" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deleted_at" TIMESTAMP, "created_at" TIMESTAMP DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying NOT NULL, "type" character varying NOT NULL, "image_link" character varying, "value" character varying NOT NULL, "weight" character varying NOT NULL, "other_informations" character varying, CONSTRAINT "PK_2147e33d09156b14a7fa36392ad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "system-params" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deleted_at" TIMESTAMP, "created_at" TIMESTAMP DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "salary_per_month" character varying NOT NULL, "working_hours_per_month" character varying NOT NULL, "profit" character varying NOT NULL, CONSTRAINT "PK_4e08b1f4f92c74bbb9b7bb922ac" PRIMARY KEY ("id"))`);
